...
public class UserFollowingApi {
    ...
    public JsonResponse<String> addUserFollowing(@RequestBody UserFollowing userFollowing){
        ...
        return JsonResponse.success(); //给用户添加一个关注的对象
    }
    ...
    public JsonResponse<List<FollowingGroup>> getUserFollowings(){
        ...
        return new JsonResponse<>(result); //返回用户所有关注的对象
    }
    ...
    public JsonResponse<List<UserFollowing>> getUserFans(){
        ...
        return new JsonResponse<>(result); //返回用户所有的粉丝
    }
    ...
    public JsonResponse<Long> addUserFollowingGroups(@RequestBody FollowingGroup followingGroup){
        ...
        return new JsonResponse<>(groupId); //添加用户关注分组，返回分组的名称,后续让前端进行分类
    }
    ...
    public JsonResponse<List<FollowingGroup>> getUserFollowingGroups(){
        ...
        return new JsonResponse<>(list); //返回所有关注分组的Id
    }
